...
?>
 ...
 <div>
	    ...
	    <form name="form1" method="POST" action="index.php?f=QuanTri_Lop">
	 	<div class="container">
      		<div class="row">	
			<h3 class="style1"> THÊM LỚP HỌC </h3>
    	    ...
    	    <table class="table table-hover"  >
          		<h3 class="style1"> Danh sách lớp</h3>
	          	<thead>
					<tr >
					  <th width="33"> STT </th>
					  <th width="80"><center>Mã Lớp</center></th>
					  <th width="340"><center>Tên Lớp</center></th>
   					  <th width="60"><center>Số lượng</center></th>
				  	  <th width="275"><center>Ngành</center></th>
					  <th width="105"><center>Hệ</center></th>
					  <th width="101">&nbsp;  </th>
					</tr>
				  </thead>
			  <tbody>
