	          	...
	          	<thead>
					<tr >
					  ...
					  <th width="100"><center>Mã Cán bộ</center></th>
 					  <th width="245"><center>Tên Cán bộ</center></th>
				  	  <th width="205"><center>Tên chức vụ</center></th>
					  <th width="131">&nbsp;  </th>
					</tr>
				  </thead>
			  <tbody>
				  <?php
					...
					"and a.maCb=b.MaCb and b.maCv=c.maCv";										 						 						 
					...
					?>
						<tr>
						  ...
						  <td><center><?php echo $row3["maCb"]; ?></center></td>	
