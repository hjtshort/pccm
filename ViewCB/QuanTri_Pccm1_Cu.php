...
<div>
	 	...
	 	<div class="container">
			...
			<font size="-2"><a href="index.php?f=xuat&idMau=<?php $chuoi=$data["maBm"]." ".$namHoc; echo $chuoi; ?>"><img src="img/excel.jpg" title="Xuất file Excel" height="30" width="30" /></a></font>
			</h3>
...
/*					$sql_hienThi = 	"SELECT * FROM chuongtrinhhoc cth, monhoc mh, nganh n ".
					...
					?>
						<tr>
						  ...
						  <td width="100" title="<?php if ($tong<270){ $st=$tong-270; echo "Thiếu ".$st." tiết"; } else if ($tong>=270) {$st=$tong-270; echo "Thừa ".$st." tiết";  }?>"><a href="index.php?f=QuanTri_Pccm&idMau=<?php $chuoi=$row["maCb"]." ".$namHoc." ".$data_lop["maLop"]; echo $chuoi; ?>"><?php echo $row["ten"]; ?></td>	
						  <td width="20"><center><?php echo $tongHk1;; ?></center></td>	
 						  <td width="20"><center><?php echo $tongHk2;; ?></center></td>	
  						  <td width="20"><b><center> <?php echo $tong; ?></center></b></td>	
						    <td><?php if ($num_rows>0) echo "NCKH-";	
									  if ($num_rows2>0) echo "TBG"; ?></td>	
						<td><?php if ($num_DtGiam>0){
			  ...
			  <?php }  ?>	
			  <tr>
			  	<td colspan="5" align="center"> Tổng số</td>
				<td><?php echo --$stt. " giảng viên"; ?> </td>
				<td> </td>
				<td></td>
			  </tr>				
			  </tbody>
