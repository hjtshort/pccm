    	    ...
    	    <table class="table" border="1"  >
	          	...
	          	<thead>
					<tr >
					  ...
					  <th width="28" valign="middle">Mã Cán bộ</th>
 					  <th width="81"  ><center>Tên cán bộ</center></th>
					  <th width="70"  ><center>Tổng số tiết</center></th>
  				      <th width="65"  ><center> Tiết nghĩa vụ  </center></th>
					  <th width="35"><center> Số tiết thiếu</center></th>
   					  <th width="28"   ><center>Ghi chú</center></th>				  
...
/*					$sql_hienThi = 	"SELECT * FROM chuongtrinhhoc cth, monhoc mh, nganh n ".
					...
					while ($row = mysqli_fetch_array($query)) {		
						...
						$row_tbg = mysqli_fetch_array($query2);
					...
					$row_nckh = mysqli_fetch_array($query1);
					...
					?>
						<tr>
						  ...
						  <td width="28"><?php echo $row["maCb"]; ?></td>	
						  <td width="81"><a href="index.php?f=QuanTri_Pccm&idMau=<?php $chuoi=$row["maCb"]." ".$namHoc." ".$data_lop["maLop"]; echo $chuoi; ?>" title="<?php echo "Thiếu ".$s_thieu." tiết"; ?>"><?php echo $row["ten"]; ?></td>	
  						  <td width="70"><center><?php echo $tong; ?></center></td>	
						  <td width="35"><center><?php echo $tc; ?></center></td>	
   						  <td width="65"><center><?php echo $s_thieu; ?></center></td>	
