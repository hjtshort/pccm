...
<div class="wrapper" style="background-color:#FFFFFF"> 
<div>
	     <form name="form1" method="POST" action='index.php?f=QuanTri_ThongKeDu&idMau=<?php echo $maCb; ?>'>
	 	<div class="container">
      		<div class="row">	
			<h3 class="style1">Cán bộ thừa tiết - Bộ môn <font color="#990000"><?php echo $data1["tenBm"]  ?></font> &nbsp;&nbsp;	Năm học: 
...
/*					$sql_hienThi = 	"SELECT * FROM chuongtrinhhoc cth, monhoc mh, nganh n ".
					...
					?>
						<tr>
						  ...
						  <td width="100"><a href="index.php?f=QuanTri_Pccm&idMau=<?php $chuoi=$row["maCb"]." ".$namHoc." ".$data_lop["maLop"]; echo $chuoi; ?>" title="<?php echo "Thừa ".$s_du." tiết";  ?>"><?php echo $row["ten"]; ?></td>	
  						  <td width="20"><center><?php echo $tong; ?></center></td>	
						  <td width="35"><center><?php echo $tc; ?></center></td>							  
   						  <td width="20"><center><?php echo $s_du; ?></center></td>	
